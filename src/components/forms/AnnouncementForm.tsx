...
export default function AnnouncementForm({
  ...
  return (
    <form className="TeacherForm flex flex-col gap-8" onSubmit={onsubmit}>
      <h1 className=" font-semibold text-xl">Create a new Announcement</h1>
    ...
    <div className="TeacherForm flex flex-col gap-2 w-full md:w-1/4 ">
      {" "}
